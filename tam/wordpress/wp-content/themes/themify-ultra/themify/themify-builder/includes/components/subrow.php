...
class Themify_Builder_Component_Subrow extends Themify_Builder_Component_Base {
	...
	if ($is_styling===true) {
	    if (isset($row['styling']['background_type']) && $row['styling']['background_type'] === 'image' && isset($row['styling']['background_zoom']) && $mod['styling']['background_zoom'] === 'zoom' && $mod['styling']['background_repeat'] === 'repeat-none') {
