...
a(this),d=b.data("label"),e=b.data("close"),f=b.data("dateformat"),g=b.data("timeformat"),l=b.data("timeseparator");a.fn.datetimepicker.call(b,{showOn:"both",showButtonPanel:!0,closeButton:e,buttonText:d,dateFormat:f,timeFormat:g,stepMinute:5,firstDay:b.data("first-day"),separator:l,onClose:function(k){""!=k&&a("#"+b.data("clear")).addClass("themifyFadeIn")},beforeShow:function(){a("#ui-datepicker-div").addClass("themifyDateTimePickerPanel")}});b.next().addClass("button")});c.find(".themifyClearDate").on("click",
...
b.attr("data-name")+'"]').remove()})},layout:function(c){c.find(".preview-icon").each(function(){var b=a(this),d=b.parent(),e=d.find(".val"),f="",g="";if(0<b.closest(".group-hide").length){g="theme-settings";var l=b.closest(".group-hide");f=l.data("hide")}else 0<b.closest(".themify_field_row").length&&(g="custom-panel",l=b.closest(".themify_field_row"),"undefined"!==typeof l.data("hide")&&(f=l.data("hide")));b.click(function(m){m.preventDefault();d.find(".selected").removeClass("selected");b.addClass("selected");
e.val(b.find("img").attr("alt")).trigger("change");""!==f&&("custom-panel"==g?(m=l.nextUntil("[data-hide]"),m.add(m.find(".themify_field .hide-if")).not(".toggled-off").filter("."+f.replace(/\s/g,",.")).show().filter("."+e.val()).hide()):"theme-settings"==g&&l.find(".hide-if").filter("."+f.replace(/\s/g,",.")).show().filter("."+e.val()).hide())});if(""!==f)if("custom-panel"==g){var k=l.nextUntil("[data-hide]");k.add(k.find(".themify_field .hide-if")).not(".toggled-off").filter("."+f.replace(/\s/g,
",.")).filter("."+e.val()).hide()}else"theme-settings"==g&&l.find(".hide-if").filter("."+f.replace(/\s/g,",.")).show().filter("."+e.val()).hide()});c.find(".themify_field .preview-icon").on("click",function(b){b.preventDefault();a(this).parent().find(".selected").removeClass("selected");a(this).addClass("selected");a(this).parent().find(".val").val(a(this).find("img").attr("alt")).trigger("change")});c.find(".themify_field_row[data-hide]").each(function(){var b=a(this).data("hide");if("string"===
...
f.children(".dropdownbutton").show():"mouseleave"===e.type&&f.children(".dropdownbutton").is(":visible")&&f.children(".dropdownbutton").hide()});b.on("click",".first-ddbtn a",function(e){e.preventDefault()});b.on("click",".ddbtn a",function(e){e.preventDefault();var f=a(this).find("img").attr("src"),g=a(this).data("val");e=a(this).closest(".dropdownbutton-list");var l=e.attr("id");a(this).closest(".dropdownbutton-list").find(".first-ddbtn img").attr("src",f);a(this).closest(".dropdownbutton").hide();
a("input#"+l).val(g);e.next().hasClass("ddbtn-all")&&(b.hasClass("multi-ddbtn")?(f=a(".multi-ddbtn-sub",b.parent().parent()),g=a(".multi-ddbtn-sub + input",b.parent().parent())):(g=e.next(),f=g.prev().siblings(".dropdownbutton-list"),g=g.siblings("input")),"yes"==e.next().val()?(f.addClass("disabled opacity-5"),f.each(function(){var k=a(this).data("def-icon");a(this).find(".first-ddbtn img").attr("src",k)}),g.val("")):f.removeClass("disabled opacity-5"))});var d=b.find("input.ddbtn-all");"yes"==d.val()&&
...
d.data("type");var e=d.parents("#themify_assignments_popup_show").find(".themify-assignment-type-options[data-type="+b+"]"),f=a("#popup_show-assignment-tab-pages").data("post-id");a.ajax({url:ajaxurl,type:"post",data:{action:"themify_create_inner_popup_page",type:b,post_id:f},beforeSend:function(){},success:function(g){e.html(g);d.data("active","on")}})}});c.on("click",".themify-assignment-pagination .page-numbers",function(b){b.preventDefault();b=a(this);var d=b.parents(".themify-assignment-options"),
e=b.parents(".themify-assignment-items-inner"),f=a(".themify-assignment-pagination",e),g=parseFloat(a(".themify-assignment-pagination .current",e).text()),l=a(".themify-assignment-items-inner",d),k=1;b.hasClass("next")?k=g+1:b.hasClass("prev")?k=g-1:b.hasClass("page-numbers")&&(k=parseFloat(b.text()));a.ajax({url:ajaxurl,type:"post",data:{action:"themify_create_popup_page_pagination",current_page:k,num_of_pages:e.data("pages")},beforeSend:function(){a(".tb_slider_loader",d).remove();a(".themify-assignment-items-page",
...
g=document.getElementById("hide_page_title"),l=g.closest(".themify_field_row"),k=[e,f,l];c.addEventListener("change",function(){if(this.checked){b.click();d.click();for(var m=2;-1<m;m--)k[m].style.opacity=.5,k[m].className+=" disabled";g.value="yes"}else for(m=2;-1<m;m--)k[m].style.opacity=1,k[m].classList.remove("disabled")})}}};h.init();return h}(jQuery);
